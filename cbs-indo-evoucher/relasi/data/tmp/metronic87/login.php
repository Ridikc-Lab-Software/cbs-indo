		...
		<div class="d-flex flex-column flex-lg-row flex-column-fluid">
			<div class="d-flex flex-lg-row-fluid">
				<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
					<img class="theme-light-show mx-auto mw-100 w-150px w-lg-400px mb-10 mb-lg-20" src="<?php echo $url; ?>assets/media/illustrations/sigma-1/17h.png" alt="">
							...
							<form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_sign_in_form" method="POST" action="">
								...
								<div class="text-center mb-11">
									...
									<div class="text-gray-500 fw-semibold fs-6">
										Masukkan email & password dibawah ini
									</div>
									<!--end::Subtitle--->
								</div>
								<!--begin::Heading-->
