...
{
    ?>
    <p href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
function tabel($width, $satuan, $border = 0, $align)
{
    ...
    echo "width='" . $width . $satuan . "' border='" . $border . "' align='" . $align . "' class='table table-hover table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'";
}
;

function tabel_head_tr()
{
    echo 'class="fw-bolder text-muted text-center"';
}
