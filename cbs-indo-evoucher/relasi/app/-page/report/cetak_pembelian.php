<form name="formcari" id="formcari" action="../data_pembelian_voucher/cetak.php" method="get" >
    <fieldset>
        <table>
            <tbody>
                <!-- <tr>
                ...
                ?>
                <tr>
                    <td style="width:40%">Dari (Tanggal Pembelian) :</td>
                    <td><input type="date" name="tanggal1" class="form-control" value="<?= $start_date_of_month; ?>">
                    </td>
                </tr>

                <tr>
                    <td style="width:40%">Sampai (Tanggal Pembelian):</td>
