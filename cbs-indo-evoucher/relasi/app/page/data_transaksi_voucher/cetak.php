...
<table border="0" style="width: 100%">
    ...
    <tr>
        <td colspan="11" align="center" class="auto-style1">
            <center>
    ...
    <tr>
        <td colspan="11" align="center" class="auto-style2">
            <center>
...
<?php
    ...
    if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1'])) {
        ...
        $text_cetak = 'Cetak Berdasarkan <b>tanggal_transaksi</b> Dari Tanggal <b>' . $tanggal1_indo . '</b> s/d <b>' . $tanggal2_indo . '</b>';
    }

    if ($text_cetak != "") {
        if (isset($_GET['export'])) {
            echo '<table width="100%" border="0"><tr><td colspan="11" align="center"><center>' . $text_cetak . '</center></td></tr></table><br>';
        }
        else {
...
?>
        ...
        <tr>
            <td colspan="9" class="text-right"><strong>Jumlah Voucher :
                    <?php echo $no; ?>
                </strong></td>
