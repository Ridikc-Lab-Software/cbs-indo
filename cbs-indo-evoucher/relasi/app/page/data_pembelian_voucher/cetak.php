...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("pembelian_voucher");
} else {
    ...
    proses_action_cetak("pembelian_voucher");
    ?>
    <style>
        .text-right {
            text-align: right;
        ...
        <?php if (isset($_GET['export'])) { ?>
            ...
            <tr>
                <td colspan="8" align="center" class="auto-style2">
                    <center>
                        <h2 style="margin: 0px;" class="auto-style1">LAPORAN PEMBELIAN E-VOUCHER</h2>
                    </center>
                </td>
            </tr>
            <tr>
                <td colspan="8" align="center" class="auto-style2"><center>SPBU <?php 
        ...
        <?php } else { ?>
            ...
            <tr>
                <td class="auto-style2">
                    <center><h2 class="auto-style1" style="margin: 0px;">LAPORAN PEMBELIAN E-VOUCHER</h2></center>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
    ...
    if (isset($_GET['isi']) && !empty($_GET['isi'])) {
        ...
        $text_cetak = 'Pembelian Dari Tanggal <b>' . $tanggal1_indo . '</b> s/d <b>' . $tanggal2_indo . '</b>';
