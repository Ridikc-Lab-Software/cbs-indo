...
<html itemscope="" itemtype="http://schema.org/Product"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
">No : <?= $id_pembayaran_umrah ?></span>
    ...
    <table>
        ...
        <tr>
            ...
            <td align="center"> :</td>
            <td>
                Pembayaran melalui asdasd untuk transaksi paket umrah dengan No.Registrasi asdsd.
            </td>
        </tr>
        <tr>
            <td>Catatan</td>
    ...
    <tbody><tr>
        ...
        <td>
            <div id="yang-menerima">
                <div>Jambi, <?= format_indo($data['tanggal_transaksi']) ?></div>
