                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>		
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                              <?php echo id_otomatis("data_tanda_tangan", "id_tanda_tangan", "10"); ?>  		
                            </td>
                        </tr>
                        h-->
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_tanda_tangan", "id_tanda_tangan", "10"); ?>" name="id_tanda_tangan" placeholder="Id Admin " id="id_tanda_tangan" required="required">
                          ...
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input  class="form-control" style="width:50%" type="file" name="tanda_tangan" id="tanda_tangan"  required="required">
                            </td>
                        </tr>
