...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_plat_kendaraan_transaksi_voucher");
} else {
    ...
    proses_action_cetak("data_plat_kendaraan_transaksi_voucher");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <center>
        <strong>LAPORAN
            ...
            <?php
            $tabelnya = "data_plat_kendaraan_transaksi_voucher";
    ...
    <table width="100%"  class="tblcms2">
        <tr>
            <th class="th_border cell">No</th>
                <!--h <th>Id plat kendaraan transaksi voucher</th> -->
                                ...
                                <th align="center" class="th_border cell">No plat kendaraan</th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_plat_kendaraan_transaksi_voucher where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_plat_kendaraan_transaksi_voucher where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_plat_kendaraan_transaksi_voucher";
            }
                ...
                <tr class="event2">
                    <td align="center" width="50"><?php $no = $no + 1; echo $no; ?></td>
                        <!--h <td align="center"><?php echo $data["id_plat_kendaraan_transaksi_voucher"]; ?></td> h-->
                                                <td align="center"><?php echo baca_database("","id_voucher","select * from data_transaksi_voucher where id_transaksi_voucher='$data[id_transaksi_voucher]'")  ?></td>
                                                <td align="center"><?php echo $data["no_plat_kendaraan"]; ?></td>
                                                <td align="center"><?php echo baca_database("","nama_supir","select * from data_supir where id_supir='$data[id_supir]'")  ?></td>
