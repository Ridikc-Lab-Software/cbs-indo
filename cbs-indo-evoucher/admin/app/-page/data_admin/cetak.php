        ...
        <tr>
            <th class="th_border cell">No</th>
                <!--h <th>Id admin</th> -->
                                ...
                                <th align="center" class="th_border cell">Foto tanda tangan</th>
                        </tr>
                ...
                <tr class="event2">
                    <td align="center" width="50"><?php $no = $no + 1; echo $no; ?></td>
                        <!--h <td align="center"><?php echo $data["id_admin"]; ?></td> h-->
                                                ...
                                                <td align="center"><a href="../../../../admin/upload/<?php echo $data['foto_tanda_tangan']; ?>"><img onerror="this.src='../../../data/image/error/file.png'" width="50" height="30" src="../../../../admin/upload/<?php echo $data['foto_tanda_tangan']; ?>"></a></td>
