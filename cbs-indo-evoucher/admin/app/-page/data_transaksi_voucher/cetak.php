...
$total_sisa = $total_sisa + $sisa_voucher;
            ...
            ?>
                <tr class="event2">
                    ...
                    <td class="text-right"><?php echo rupiah($nominal_voucher); ?></td>
                    <td class="text-right"><?php echo rupiah($data['nominal']); ?></td>
                    <td class="text-right"><?php echo rupiah($sisa_voucher); ?></td>
                    <td align="center">
                        <?php
            ...
            <tr>
                <td colspan="10" class="text-right"><strong>Jumlah Voucher : <?php echo $no; ?></strong></td>
                <td class="text-right"><strong><?php echo rupiah($total); ?></strong></td>
                <td class="text-right"><strong><?php echo rupiah($total_sisa); ?></strong></td>
