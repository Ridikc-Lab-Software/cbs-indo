    ...
    <table width="100%"  class="tblcms2">
        <tr>
            <th class="th_border cell">No</th>
                <!--h <th>Id plat</th> -->
                                <th align="center" class="th_border cell">Plat</th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_plat where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_plat where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_plat";
            }
