...
if (isset($_GET['input'])) {
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Spbu </th> h-->
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_spbu where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_spbu where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
            ...
            while ($data = mysql_fetch_array($proses)) {
                ...
                <tr class="event2">
                    ...
                    <!--h <td align="center"><?php echo $data['id_spbu']; ?></td> h-->
                        <td align="center"><?php echo $data['nama_spbu']; ?></td>
                        <td align="center"><?php echo $data['alamat1']; ?></td>
                        <td align="center"><?php echo $data['alamat2']; ?></td>
                        <td align="center"><?php echo $data['telepon']; ?></td>
                        <td align="center"><?php echo $data['penutup']; ?></td>
