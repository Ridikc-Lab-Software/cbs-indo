<div class="flex-lg-row-fluid">
    ...
    <div class="container">
        <div class="row">
            ...
            $querytabel = "SELECT * FROM data_voucher,data_relasi WHERE data_voucher.id_relasi = data_relasi.id_relasi and  (status = 'Unused' AND tanggal_kadaluarsa <= NOW())  LIMIT $startRow ,$dataPerPage";
            $querypagination = "SELECT count(*) as total FROM data_voucher,data_relasi WHERE data_voucher.id_relasi = data_relasi.id_relasi and  (status = 'Unused' AND tanggal_kadaluarsa <= NOW())";
...
<Center>
    ...
    <?php Pagination_custom_url("?input=voucher_kadaluarsa&", $page, $dataPerPage, $querypagination); ?>
</Center>