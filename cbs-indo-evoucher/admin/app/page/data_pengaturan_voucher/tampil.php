<body>
    ...
    <a target="blank" href="cetak.php?berdasarkan=data_pengaturan_voucher&jenis=xls&pakaiperperiode=<?php echo $status_pakaiperperiode; ?>">
        <?php btn_export('Export Excel'); ?>
    </a>

    <a target="blank" href="cetak.php?berdasarkan=data_pengaturan_voucher&jenis=print&pakaiperperiode=<?php echo $status_pakaiperperiode; ?>">
        <?php btn_cetak('Cetak'); ?>
    </a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select class="form-control selectpicker" data-live-search="true" name="Berdasarkan" id="Berdasarkan">
                                <?php
                                $sql = "desc data_pengaturan_voucher";
        ...
        <table <?php tabel(100, '%', 1, 'left'); ?>>
            ...
            <tbody>
                ...
                if (isset($_GET['Berdasarkan']) && !empty($_GET['Berdasarkan']) && isset($_GET['isi']) && !empty($_GET['isi'])) {
                    ...
                    $querytabel = "SELECT * FROM data_pengaturan_voucher where $berdasarkan like '%$isi%'  LIMIT $startRow ,$dataPerPage";
                    $querypagination = "SELECT COUNT(*) AS total FROM data_pengaturan_voucher where $berdasarkan like '%$isi%'";
                } else {
                    $querytabel = "SELECT * FROM data_pengaturan_voucher  LIMIT $startRow ,$dataPerPage";
                    $querypagination = "SELECT COUNT(*) AS total FROM data_pengaturan_voucher";
                }
