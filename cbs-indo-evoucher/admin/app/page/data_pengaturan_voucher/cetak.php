...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_pengaturan_voucher");
} else {
    ...
    proses_action_cetak("data_pengaturan_voucher");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <center>
        <strong>LAPORAN
            ...
            <?php
            $tabelnya = "data_pengaturan_voucher";
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Pengaturan </th> h-->
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_pengaturan_voucher where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_pengaturan_voucher where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
