...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-warning">
        ...
        <strong>Edit Data Log Activity </strong>
        <hr class="message-inner-separator">
            <p>Silahkan Update Data Log Activity  dibawah ini.</p>
        </div>
    </div>
                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>	
                    ...
                    <tr>
                        <td width="25%" class="leftrowcms">					
                            <label >Id Log Activity  <font color="red">*</font></label>
                        </td>
                        <td width="2%">:</td>
                        <td>
                           <?php echo $data['id_log_activity']; ?>	
                        </td>
                    </tr>
                    h-->
                    <input type="hidden" class="form-control" name="id_log_activity" value="<?php echo $data['id_log_activity']; ?>" readonly  id="id_log_activity" required="required">
