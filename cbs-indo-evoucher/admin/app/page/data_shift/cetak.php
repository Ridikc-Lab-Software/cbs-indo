...
if (isset($_GET['input'])) {
    ...
    proses_action_cetak("data_shift");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        <tr>
            <th class="th_border cell">No</th>
                <!--h <th>Id shift</th> -->
                                ...
                                <th align="center" class="th_border cell">Jam mulai</th>
                                <th align="center" class="th_border cell">Jam selesai</th>
                        </tr>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_shift where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_shift where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_shift";
            }
                ...
                <tr class="event2">
                    <td align="center" width="50"><?php $no = $no + 1; echo $no; ?></td>
                        <!--h <td align="center"><?php echo $data["id_shift"]; ?></td> h-->
                                                ...
                                                <td align="center"><?php echo $data["jam_mulai"]; ?></td>
                                                <td align="center"><?php echo $data["jam_selesai"]; ?></td>
