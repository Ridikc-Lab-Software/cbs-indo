<body>
    ...
    <a target="blank" href="cetak.php?berdasarkan=data_pengaturan&jenis=xls&pakaiperperiode=<?php echo $status_pakaiperperiode; ?>">
        <?php btn_export("Export Excel"); ?>
    </a>

    <a target="blank" href="cetak.php?berdasarkan=data_pengaturan&jenis=print&pakaiperperiode=<?php echo $status_pakaiperperiode; ?>">
        <?php btn_cetak("Cetak"); ?>
    </a>
        ...
        <table <?php tabel(100, "%", 1, "left"); ?>>
            ...
            <tbody>
                ...
                if (
                    ...
                    $querytabel = "SELECT * FROM data_pengaturan where $berdasarkan like '%$isi%'  LIMIT $startRow ,$dataPerPage";
                    $querypagination = "SELECT COUNT(*) AS total FROM data_pengaturan where $berdasarkan like '%$isi%'";
                } else {
                    $querytabel = "SELECT * FROM data_pengaturan  LIMIT $startRow ,$dataPerPage";
                    $querypagination =
                        "SELECT COUNT(*) AS total FROM data_pengaturan";
                }
