                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            ...
                                            <span class="text-muted fw-bold d-block fs-7">Member : <strong><?php echo !empty($data['nama_member']) && $data['nama_member'] !== 'NON MEMBER' ? $data['nama_member'] : 'Non Member'; ?></strong></span>
                                        </div>
                                    </div>
                                </td>
                                <td>
