                    ...
                    <div class="d-flex my-4">
                        <div class="me-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="../data_relasi/index.php?input=edit&proses=<?php echo $_GET['id']; ?>"
                                        target="_blank" class="menu-link px-3">Edit Relasi</a>
                                </div>
                                <!--end::Menu item-->
                ...
                <div class="d-flex flex-wrap flex-stack">
                    ...
                    <div class="d-flex flex-column flex-grow-1 pe-8">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <a href="../data_voucher/?input=vouher_keseluruhan&id=<?php echo $nama; ?>&filter=aktif">
                                <div
                            ...
                            <a
                                href="../data_voucher/?input=vouher_keseluruhan&id=<?php echo $nama; ?>&filter=digunakan">
                                <div
                                    class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <!--begin::Number-->
                                    <div class="d-flex align-items-center">
                            ...
                            <a
                                href="../data_voucher/?input=vouher_keseluruhan&id=<?php echo $nama; ?>&filter=kadaluarsa">
                                <div
                                    class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <!--begin::Number-->
                                    <div class="d-flex align-items-center">
                            ...
                            <a href="../data_voucher/?input=vouher_keseluruhan&id=<?php echo $nama; ?>&filter=semua">
                                <div
                                    class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <!--begin::Number-->
                                    <div class="d-flex align-items-center">
        ...
        <div class="modal-dialog">
            <form id="formSupir" class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Search Member Input -->
                    <div class="mb-5">
                        <label class="form-label fw-bold">Cari Member (Nama / No Telepon):</label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="search_member_input" placeholder="Ketik nama atau no telepon member..." autocomplete="off">
                            <button class="btn btn-secondary" type="button" id="btn_search_member">Cari</button>
                        </div>
                        <!-- Search Results Container -->
                        <div id="member_search_results" class="border rounded p-2 mt-2 bg-light d-none" style="max-height: 150px; overflow-y: auto;"></div>
                    </div>

                    <!-- Driver Name (Readonly) -->
                    <div class="mb-5">
                        <label class="form-label fw-bold">Nama Supir:</label>
                        <input class="form-control bg-secondary text-dark" name="nama_supir" id="nama_supir_input" placeholder="Pilih member di atas..." readonly required>
...
<script>
    ...
    const searchMemberInput = document.getElementById('search_member_input');
    const memberSearchResults = document.getElementById('member_search_results');
    const namaSupirInput = document.getElementById('nama_supir_input');
    const idMemberInput = document.getElementById('id_member_input');
    const btnSearchMember = document.getElementById('btn_search_member');
    ...
    function doSearchMember() {
        ...
        fetch('apisupir.php?aksi=search_member&query=' + encodeURIComponent(query))
            .then(r => r.json())
            .then(data => {
                memberSearchResults.innerHTML = '';
                if (data.length === 0) {
                    memberSearchResults.innerHTML = '<div class="text-muted p-2 fs-7">Member tidak ditemukan.</div>';
                ...
                data.forEach(m => {
                    ...
                    div.className = 'p-2 border-bottom border-gray-200 cursor-pointer text-hover-primary member-result-item';
                    div.style.cursor = 'pointer';
                    div.innerHTML = `<div class="fw-bold text-dark">${m.nama}</div><div class="text-muted fs-7">${m.no_telepon || '-'}</div>`;
                    div.onclick = () => {
                        namaSupirInput.value = m.nama;
                        idMemberInput.value = m.id_member;
    ...
    searchMemberInput.addEventListener('input', doSearchMember);
    btnSearchMember.addEventListener('click', doSearchMember);
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-sm btn-warning"
                        onclick="editSupir('${s.id_supir}','${s.nama_supir}','${s.id_member || ''}')">Edit</button>
    ...
    function editSupir(id, nama, id_member) {
        aksiSupir.value = 'edit';
        formSupir.id_supir.value = id;
        namaSupirInput.value = nama;
        idMemberInput.value = id_member;
        searchMemberInput.value = '';
        memberSearchResults.innerHTML = '';
        memberSearchResults.classList.add('d-none');
        modalSupir.show();
    ...
    <div class="card card-xxl-stretch mb-5 mb-xl-12">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Penjualan E-Voucher</span>
            ...
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                ...
                <a href="../data_voucher/?input=vouher_keseluruhan&id=<?php echo ($nama); ?>"
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted">
                            ...
                            <th class="min-w-150px">Kode Penjualan</th>
