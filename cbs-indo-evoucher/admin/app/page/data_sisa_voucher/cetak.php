...
if (!empty($_GET['relasi'])) {
    ...
    if (empty($nama_relasi))
        $nama_relasi = "Tidak Diketahui";
...
?>
        <tr class="event2">
            ...
            <td align="center">
                <?php echo format_indo($data["tanggal_transaksi"]); ?>
            </td>
            <td align="right">
                <?php echo rupiah($data["nominal_voucher"]); ?>
            </td>
            <td align="right">
                <?php echo rupiah($data["nominal_transaksi"]); ?>
            </td>
            <td align="right">
                <?php echo rupiah($data["nominal_sisa"]); ?>
            </td>
        </tr>
        <?php
    }
        ...
        <tr style="background-color: #f0f0f0; font-weight: bold; font-size: 14px;">
            ...
            <td align="right" style="padding: 12px;">
                <?php echo rupiah($total_sisa_keseluruhan); ?>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tr>
        <td>
            ...
            <table style="width: 50%;  border-collapse: collapse; font-size: 14px;">
                <tbody>
                    <tr>
                        <td style="padding: 8px; border-bottom: 1px solid #ddd;"><strong>Nama Relasi</strong></td>
                        <td style="padding: 8px; border-bottom: 1px solid #ddd;"><strong></strong></td>
                        <td style="padding: 8px; border-bottom: 1px solid #ddd;"><strong>Nominal Sisa</strong></td>
                    </tr>
                    <?php
