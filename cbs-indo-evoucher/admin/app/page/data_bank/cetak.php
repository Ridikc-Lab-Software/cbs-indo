...
if (isset($_GET['input'])) {
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Bank </th> h-->
                <th align="center" class="th_border cell"  >Nama Bank </th>
                <th align="center" class="th_border cell"  >Nomor Rekening </th>
        ...
        <tbody>
            ...
            while ($data = mysql_fetch_array($proses)) {
                ...
                <tr class="event2">
                    ...
                    <!--h <td align="center"><?php echo $data['id_bank']; ?></td> h-->
                        <td align="center"><?php echo $data['nama_bank']; ?></td>
                        <td align="center"><?php echo $data['nomor_rekening']; ?></td>
