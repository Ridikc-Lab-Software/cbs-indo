  ...
  <body id="form-cetak-invoice" style="">
        ...
        <tr>
          <td>
            ...
            <div class="background-color-5 border-color-50" style="border: 1px solid; padding: 2mm; margin-bottom: 3mm;">
              <div style="font-weight: bold;margin-bottom: -1mm;position: relative;"> INVOICE INV{invoice} </div>
              <!-- <div>
          ...
          <td style="text-align: right !important;">
            ...
            <div style="margin-bottom: 5mm;">
              <div>
                <div>
                  <b>KEPADA </b>
                  <br> {nama_relasi} <br> {alamat_relasi} <br> {email_relasi} <br> {telepon_relasi}
                </div>
              </div>
            </div>
          </td>
    ...
    <div style="margin-bottom: 5mm;">
      ...
      <table class="tabel-detail-invoice" style="width: 100%" border="1">
        ...
        <tbody>
          <tr>
            <td colspan="2" style="padding:5px;height:30px;text-align:center">Pembayaran E-Voucher Kode INV{invoice}</td>
            <td class="right" style="padding:5px;width:150px; text-align: right !important;"> {total_bayar} </td>
          </tr>
          <tr>
            <td class="center"> Terbilang : {terbilang}</td>
            <td class="left" style="padding:5px;height:30px;width:150px; text-align: left !important;">Total Tagihan</td>
            <td class="right" style="padding:5px;height:30px;width:150px; text-align: right !important;"> {total_bayar} </td>
          </tr>
        </tbody>
      </table>
    </div>
        ...
        <tr>
          ...
          <td style="align-content: baseline;">
            <div id="yang-menerima">
              <div style="margin-bottom: 0pt; text-align:center;">Sarolangun, {tanggal} </div>
              <div style="margin-bottom: 10pt; text-align:center;">
                <img src="{tanda_tangan}"> {admin} <br> {jabatan}
              </div>
            </div>
          </td>
        </tr>
