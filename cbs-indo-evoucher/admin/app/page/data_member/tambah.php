                    ...
                    <tbody>
                        ...
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_member", "id_member", "10"); ?>" name="id_member" placeholder="Id Member " id="id_member" required="required">
                          ...
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input  class="form-control" style="width:50%" type="varchar" name="nik" id="nik" placeholder="Nik " required="required">
                            </td>
                        </tr>
                          <tr>
                            <td width="25%" class="leftrowcms">
                          ...
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input  class="form-control" style="width:50%" type="date" name="tanggal_terdaftar" id="tanggal_terdaftar" placeholder="Tanggal Terdaftar " required="required">
                            </td>
                        </tr>
                          <tr>
                            <td width="25%" class="leftrowcms">
                          ...
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input  class="form-control" style="width:50%" type="varchar" name="kode_rfid" id="kode_rfid" placeholder="Kode Rfid " required="required">
                            </td>
                        </tr>
                          <tr>
                            <td width="25%" class="leftrowcms">
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input onkeypress='return a(event)' class="form-control" style="width:50%" type="int" name="point" id="point" placeholder="Point " required="required">
                            </td>
                        </tr>
                          <tr>
                            <td width="25%" class="leftrowcms">
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <option></option><?php combo_enum('data_member','agama',''); ?>
                                </select>
                            </td>
                        </tr>
                          <tr>
                            ...
                            <td>
                                ...
                                <option></option><?php combo_enum('data_member','status_perkawinan',''); ?>
                                </select>
                            </td>
                        </tr>
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input  class="form-control" style="width:50%" type="varchar" name="pekerjaan" id="pekerjaan" placeholder="Pekerjaan " required="required">
                            </td>
                        </tr>
                          <tr>
                            <td width="25%" class="leftrowcms">
                            ...
                            <td>
                                ...
                                <option></option><?php combo_database_v2('data_admin','id_admin','hak_akses',''); ?>
                                </select>
                            </td>
                        </tr>
