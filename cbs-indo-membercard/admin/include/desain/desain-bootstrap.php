...
{
    echo "<button class='btn btn-default' ><i class='fa fa-sync'></i> " . $namatombol . "</button>";
};
...
{
    echo "<button type='submit' class='btn btn-warning'><i class='fas fa-pen-to-square'></i> Edit</button>";
};
function btn_hapus($namatombol)
{
    echo "<button type='submit' class='btn btn-danger'><i class='fas fa-trash-can'></i> Hapus</button>";
};
...
{
    echo "<button class='btn btn-secondary' ><i class='fa fa-backward'></i>" . $namatombol . "</button>";
};

function btn_cari($namatombol)
{
    echo "<button class='btn btn-secondary' ><i class='fas fa-magnifying-glass'></i>" . $namatombol . "</button>";
};
function btn_filter($namatombol)
{
    echo "<button class='btn btn-secondary' ><i class='fas fa-filter'></i>" . $namatombol . "</button>";
};
