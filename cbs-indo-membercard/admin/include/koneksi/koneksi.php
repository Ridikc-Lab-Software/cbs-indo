...
include dirname(__FILE__) . '/pixie/vendor/autoload.php';
//database
//$db_server	= "localhost";
// $db_username	= "ridikcco_databases_2021_cbs_indo";
// $db_password	= "databases_2021_cbs_indo";
// $database	= "ridikcco_databases_2021_cbs_indo";


// $db_server	= "localhost";
// $db_username	= "delsigna_databases_2021_cbs_indo";
// $db_password	= "databases_2021_cbs_indo";
// $database	= "delsigna_databases_2021_cbs_indo";
