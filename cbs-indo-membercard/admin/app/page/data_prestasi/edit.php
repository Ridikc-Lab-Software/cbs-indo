			...
			<div id="postcustom">
				<table <?php tabel_in(100, '%', 0, 'center');  ?>>
					<tbody>
						...
						$sql = mysql_query("SELECT * FROM data_prestasi where id_prestasi = '$proses'");
						$data = mysql_fetch_array($sql);
						?>
						<tr>
							<td width="25%" class="leftrowcms">
								<label>id&nbsp;prestasi <font color="red">*</font></label>
							</td>
							<td width="2%">:</td>
							<td>
								<input type="%typepertama%" name="id_prestasi" value="<?php echo $data['id_prestasi']; ?>" readonly id="id_prestasi" required="required">
							</td>
						</tr>
