					...
					<tbody>
						<tr>
							<td width="25%" class="leftrowcms">
								<label>id&nbsp;prestasi <span class="highlight">*</span></label>
							</td>
							<td width="2%">:</td>
							<td>
								<input type="readonly" readonly value="<?php echo id_otomatis("data_prestasi", "id_prestasi", "10"); ?>" name="id_prestasi" placeholder="id_prestasi" id="id_prestasi" required="required">
							</td>
						</tr>
