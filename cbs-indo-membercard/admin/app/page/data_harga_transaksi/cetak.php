...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_harga_transaksi");
} else {
    ...
    proses_action_cetak("data_harga_transaksi");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_harga_transaksi where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_harga_transaksi where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_harga_transaksi";
            }
                ...
                <tr class="event2">
                    <td align="center" width="50"><?php $no = $no + 1; echo $no; ?></td>
                        <!--h <td align="center"><?php echo $data["id_harga_transaksi"]; ?></td> h-->
                                                <td align="center"><?php echo baca_database("","tanggal","select * from data_transaksi where id_transaksi='$data[id_transaksi]'")  ?></td>
