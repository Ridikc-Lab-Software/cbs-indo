...
<?php echo $data['isi'] ?>
						...
						<tr>
							...
							<td width="2%">:</td>
							<td>
								<select class='text' required="required" type="text" name="kategori_berita" id="isi" placeholder="Isi" value="<?php echo ($data['kategori_berita']); ?>">

									<option><?php echo $data['kategori_berita'] ?></option><?php combo_enum("data_berita", "kategori_berita", "") ?>
								</select>
