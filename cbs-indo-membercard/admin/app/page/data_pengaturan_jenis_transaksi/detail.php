...
<table <?php tabel_in(100,'%',0,'center');  ?>>		
	...
	<tr class="event3">
		<td class="clleft" colspan="3">
			Detail data&nbsp;pengaturan&nbsp;jenis&nbsp;transaksi
		</td>
	</tr>	
			<?php
...
if (!isset($_GET['proses']))
{
	...
	die();
			...
			?>
			   <tr>
				<td class="clleft" width="25%">id&nbsp;pengaturan&nbsp;jenis&nbsp;transaksi</td>
				<td class="clleft" width="2%">:</td>
				<td class="clleft"><?php echo $data['id_pengaturan_jenis_transaksi']; ?></td>	
			   </tr>
