            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="../data_member_32/" class="btn btn-primary">Data SPBU 24.373.32</a>
                        <a href="../data_member/" class="btn btn-warning">Data Keseluruhan</a>
                    </td>
                </tr>
    ...
    <table <?php tabel(100, '%', 1, 'left'); ?>>
        ...
        <tbody>
            ...
            if (isset($_GET['Berdasarkan']) && !empty($_GET['Berdasarkan']) && isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_member where $berdasarkan like '%$isi%' and (spbu='24.373.27 Sarolangun' or spbu='24.373.32 Singkut')  LIMIT $startRow ,$dataPerPage";
                $querypagination = "SELECT COUNT(*) AS total FROM data_member where $berdasarkan like '%$isi%' and (spbu='24.373.27 Sarolangun' or spbu='24.373.32 Singkut') LIMIT $startRow ,$dataPerPage";
            } else {
                $querytabel = "SELECT * FROM data_member where (spbu='24.373.27 Sarolangun' or spbu='24.373.32 Singkut') LIMIT $startRow ,$dataPerPage";
                $querypagination = "SELECT COUNT(*) AS total FROM data_member where (spbu='24.373.27 Sarolangun' or spbu='24.373.32 Singkut') LIMIT $startRow ,$dataPerPage ";
            }
