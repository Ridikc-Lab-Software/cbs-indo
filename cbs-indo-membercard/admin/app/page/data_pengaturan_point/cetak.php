...
{   
	...
	<?php
	action_cetak("data_pengaturan_point"); 
}
else
{
	function location() { return "cetak"; }
	include '../../../include/all_include.php';
	proses_action_cetak("data_pengaturan_point");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
        ...
        <td class="auto-style2">
            <center>
                <strong>LAPORAN
                    ...
                    <?php
			$tabelnya = "data_pengaturan_point";
...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;pengaturan&nbsp;point</th>
        <th class="th_border cell"  >nama&nbsp;pengaturan</th>
...
<th class="th_border cell"  >point</th>
    ...
    <?php
				...
				if (isset($_GET['isi']) && !empty($_GET['isi']))
				{
					...
					$querytabel="SELECT * FROM data_pengaturan_point where $Berdasarkan like '%$isi%'";
				}
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_pengaturan_point where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
				
				}
				else
				{
					//SEMUA
					$querytabel="SELECT * FROM data_pengaturan_point";
				}
