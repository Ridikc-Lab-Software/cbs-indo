			...
			<div id="postcustom">
				<table <?php tabel_in(100, '%', 0, 'center');  ?>>
					<tbody>
						...
						$sql = mysql_query("SELECT * FROM data_event where id_event = '$proses'");
						$data = mysql_fetch_array($sql);
						?>
						<tr>
							<td width="25%" class="leftrowcms">
								<label>id&nbsp;event <font color="red">*</font></label>
							</td>
							<td width="2%">:</td>
							<td>
								<input type="%typepertama%" name="id_event" value="<?php echo $data['id_event']; ?>" readonly id="id_event" required="required">
							</td>
						</tr>
						...
						<tr>
							...
							<td width="2%">:</td>
							<td>
								<textarea class='form-control' required="required" type="text" name="isi" id="isi" placeholder="Isi" value="<?php echo ($data['isi']); ?>">
<?php echo $data['isi'] ?>
</textarea>
