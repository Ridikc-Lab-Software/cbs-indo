        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../data_member_27/" class="btn btn-warning">Data SPBU 24.373.27</a>
    ...
    <table <?php tabel(100, '%', 1, 'left'); ?>>
        ...
        <tbody>
            ...
            if (isset($_GET['Berdasarkan']) && !empty($_GET['Berdasarkan']) && isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querypagination = "SELECT COUNT(*) AS total FROM data_member where $berdasarkan like '%$isi%' LIMIT $startRow ,$dataPerPage";
            } else {


                $querytabel = "SELECT * FROM data_member where spbu LIKE '%24.373.27 Sarolangun%' ";
                $querypagination = "SELECT COUNT(*) AS total FROM data_member where spbu LIKE '%24.373.27 Sarolangun%'";
            }
