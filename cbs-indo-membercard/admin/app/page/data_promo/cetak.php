...
{   
	...
	<?php
	action_cetak("data_promo"); 
}
else
{
	function location() { return "cetak"; }
	include '../../../include/all_include.php';
	proses_action_cetak("data_promo");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;promo</th>
        <th class="th_border cell"  >tanggal&nbsp;mulai&nbsp;berlaku</th>
<th class="th_border cell"  >tanggal&nbsp;batas&nbsp;berlaku</th>
<th class="th_border cell"  >aktifkan&nbsp;pembatasan&nbsp;waktu</th>
<th class="th_border cell"  >nama&nbsp;promo</th>
<th class="th_border cell"  >keterangan</th>
<th class="th_border cell"  >syarat&nbsp;dan&nbsp;ketentuan</th>
<th class="th_border cell"  >foto&nbsp;promo</th>
<th class="th_border cell"  >jumlah&nbsp;point</th>
<th class="th_border cell"  >id&nbsp;mitra</th>
<th class="th_border cell"  >Nama Mitra</th>
<th class="th_border cell"  >status</th>
    ...
    <?php
				...
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_promo where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
...
<td align="center"><?php echo ($data['aktifkan_pembatasan_waktu']); ?></td>
<td align="center"><?php echo ($data['nama_promo']); ?></td>
<td align="center"><?php echo ($data['keterangan']); ?></td>
<td align="center"><?php echo ($data['syarat_dan_ketentuan']); ?></td>
<td align="center"><a href='../../../../admin/upload/<?php echo $data['foto_promo']; ?>'><img onerror="<?php echo $imageerror; ?>'" width='50' height='30' src='../../../../admin/upload/<?php echo $data['foto_promo']; ?>'></a></td>
<td align="center"><?php echo ($data['jumlah_point']); ?></td>
<td align="center"><?php echo ($data['id_mitra']); ?></td>
