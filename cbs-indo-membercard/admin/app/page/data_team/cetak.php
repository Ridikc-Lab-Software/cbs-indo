...
{   
	...
	<?php
	action_cetak("data_team"); 
}
else
{
	function location() { return "cetak"; }
	include '../../../include/all_include.php';
	proses_action_cetak("data_team");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;team</th>
        <th class="th_border cell"  >nama&nbsp;team</th>
<th class="th_border cell"  >foto</th>
<th class="th_border cell"  >email</th>
<th class="th_border cell"  >alamat</th>
<th class="th_border cell"  >telepon</th>
<th class="th_border cell"  >bagian</th>
    ...
    <?php
				...
				if (isset($_GET['isi']) && !empty($_GET['isi']))
				{
					...
					$querytabel="SELECT * FROM data_team where $Berdasarkan like '%$isi%'";
				}
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_team where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
				
				}
				else
				{
					//SEMUA
					$querytabel="SELECT * FROM data_team";
				}
        ...
        <tr class="event2">
            ...
            <td align="center"><?php echo $data['id_team']; ?></td>

            <td align="center"><?php echo ($data['nama_team']); ?></td>
