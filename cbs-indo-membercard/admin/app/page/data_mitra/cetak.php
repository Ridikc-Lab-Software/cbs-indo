...
{   
	...
	<?php
	action_cetak("data_mitra"); 
}
else
{
	function location() { return "cetak"; }
	include '../../../include/all_include.php';
	proses_action_cetak("data_mitra");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
...
<th class="th_border cell"  >no&nbsp;telepon&nbsp;pemilik</th>
<th class="th_border cell"  >tanggal&nbsp;daftar</th>
...
<th class="th_border cell"  >gambar&nbsp;logo</th>
    ...
    <?php
				...
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_mitra where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
        ...
        <tr class="event2">
            ...
            <td align="center"><?php echo ($data['nama_mitra']); ?></td>
<td align="center"><?php echo ($data['alamat']); ?></td>
<td align="center"><?php echo ($data['no_telepon']); ?></td>
<td align="center"><?php echo ($data['nama_pemilik']); ?></td>
<td align="center"><?php echo ($data['no_telepon_pemilik']); ?></td>
<td align="center"><?php echo (format_indo($data['tanggal_daftar'])); ?></td>
