...
class Backup_Database
{
    ...
    public function backupTables($tables = '*')
    {
        try {
             ...
             * Iterate tables
             */
            $this->obfPrint(" Harap tunggu... ");
            foreach ($tables as $table) {
                $this->obfPrint("Proses Backing up `" . $table . "` table..." . str_repeat('.', 50 - strlen($table)), 0, 0);
