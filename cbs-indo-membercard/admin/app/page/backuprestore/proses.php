...
{
	if ($_POST['password'] == "ridikcindustries")
	{
		echo "BERHASIL DIPROSES..!!!";
	}
	else
	{
		echo "GAGAL DIPROSES..!!!";
...
define("BACKUP_DIR", '../../../upload'); // Comment this line to use same script's directory ('.')
...
?>
<a href="index.php?input=restore">Selesai</a>
