						...
						<tr class="event2">
							...
							<td align="left">
								<form action="" method="get">
									...
									<input type="number" style="width: 3em" min="1" max="<?php echo $max; ?>" value="<?php $jumlah_keseluruhan = $jumlah_keseluruhan +  ($data["$jumlah"]);
		...
		<?php if ($pakai_ongkir == "ya") { ?>
			...
			<script>
				function proses() {
					...
					$.ajax({
						url: 'home/include/function/ongkir.php',
						type: 'POST',
						dataType: 'json',
						data: {
							'isi': input,
				...
				<div class="col-md-6">
					<table class="table">
						<tr>
							...
							<td>:</td>
							<td>
								<select onchange="proses();" required class='form-control' data-live-search='true' name="kurir" id="kurir" placeholder="id&nbsp;menu1" required="required">
						...
						<tr>
							...
							<td>:</td>
							<td>
								<select onchange="proses();" required class='form-control' data-live-search='true' name="tujuan" id="tujuan" placeholder="id&nbsp;menu1" required="required">
