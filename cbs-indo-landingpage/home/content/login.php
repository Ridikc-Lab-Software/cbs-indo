        ...
        <div class="login">
            <div class="wrap">
             ...
             <!-- SLIDER -->
                <div class="content">
                    <!-- LOGO -->
                    <div class="logo" style='width : 150px; margin-top: 30px; left: 30px'>
                       <br>
					   <a href="#"><img src="admin/data/image/logo/logo2.png"  alt=""></a>
                    </div>
                    <!-- SLIDESHOW -->
                    <div id="slideshow">
                        <div class="one">
                        ...
                        <div class="two">
                            ...
                            <p>Sign up to know your active point</p>
                        </div>
                        <div class="four">
                ...
                <div class="user">
                    ...
                    <div class="form-wrap">
                        <!-- TABS -->
                    	<div class="tabs">
                           <h3 class="login-tab"><a class="log-in active" href="#login-tab-content"> <center><span>Login<span></a></h3></center><!--
                    	...
                    	<div class="tabs-content">
                    		...
                    		<div id="login-tab-content" class="active">
                    			   <form method="post" action="">
                    				<input type="text" class="input" name="username" autocomplete="off" placeholder="Email or Username">
                    				<input type="password" class="input" name="password" autocomplete="off" placeholder="Password">
                    			
                    			<center>	<button name="login" type="submit" class="theme-btn" value="LOGIN">asd </button> </center>
                    			</form>
