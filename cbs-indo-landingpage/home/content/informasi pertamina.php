<?php 
function berita($tabel,$id,$tanggal,$judul,$foto,$isi,$kategori_berita)
{
	if (!(isset($_GET['Go'])))
	{
	?>
...
<section class="blog-pg-section section-padding">
    ...
    <?php
				...
				$isi = $_GET['isi'];
				$querytabel="SELECT * FROM $tabel where $berdasarkan like '%$isi%' AND kategori_berita='Informasi Pertamina' LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM $tabel where $berdasarkan like '%$isi%'  AND kategori_berita='Informasi Pertamina' ";
				}
				else if (isset($_GET['kategori_berita']) && !empty($_GET['kategori_berita']))
				{
				$kategori_berita = "Informasi Pertamina";
				$isi = $_GET['isi'];
				$querytabel="SELECT * FROM $tabel where kategori_berita = '$kategori_berita'  LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM $tabel where kategori_berita = '$kategori_berita' ";
				}
				else
				{
				$querytabel="SELECT * FROM data_berita where katgeori_berita='Informasi Pertamina' LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM data_berita where kategori_berita='Informasi Pertamina'";
				}
