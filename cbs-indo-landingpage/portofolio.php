    ...
    <div class="container-fluid">
      ...
      <ul class="row portfolio-item">
          	<?php
				...
				$querytabel="SELECT * FROM data_portofolio where $berdasarkan like '%$isi%'  ";
				$querypagination="SELECT COUNT(*) AS total FROM data_portofolio where $berdasarkan like '%$isi%'";
				}
				else
				{
				$querytabel="SELECT * FROM data_portofolio  ";
        ...
        <li class="mix dev col-xl-3 col-md-4 col-12 col-sm-6 pd">
          <img src="membercard/admin/upload/<?php echo $data['logo'] ?>" itemprop="thumbnail" alt="Image description"  style="max-width:100vh;"  />
          <div class="portfolio-overlay">
            <div class="overlay-content">
              <p class="category"><?php echo $data['keterangan']?></p>
              <a href="#" title="View Project" target="_blank">
                <div class="magnify-icon">
                  <p><span><i class="fa fa-link" aria-hidden="true"></i></span></p>
                </div>
              </a>
              <a data-fancybox="item" title="click to zoom-in" href="membercard/admin/upload/<?php echo $data['logo'] ?>">
                <div class="magnify-icon">
