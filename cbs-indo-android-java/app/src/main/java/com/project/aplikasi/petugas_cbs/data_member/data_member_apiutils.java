...
public class data_member_apiutils {


    public static data_member_apiservice getAPIService() {
        return config_apiclient.getClient(BASE_URL).create( data_member_apiservice.class);
    }
}
