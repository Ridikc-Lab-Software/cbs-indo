...
public class data_group_jenis_transaksi_activity_v2 extends AppCompatActivity {

    ArrayList<data_group_jenis_transaksi_apidata> result = new ArrayList<>();
    data_group_jenis_transaksi_adapter_v2 adapter;
    RecyclerView data_group_jenis_transaksi_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_group_jenis_transaksi_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_group_jenis_transaksi_activity_v2.this);
        ...
        fetch_data_group_jenis_transaksi();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( data_group_jenis_transaksi_activity_v2.this,
                        data_group_jenis_transaksi_tambah.class);
    ...
    public void fetch_data_group_jenis_transaksi(){
		
		if (isRefresh){
			loading.showDialog(1,"Please Wait","Loading Data..");
          }
        String token = new config_global().ambil(this);
        mAPIService.tampil_data_group_jenis_transaksi(
                "","", "", "","","", "Bearer "+token
        ).enqueue(new Callback<data_group_jenis_transaksi_api>() {
            @Override
            public void onResponse(Call<data_group_jenis_transaksi_api> call, Response<data_group_jenis_transaksi_api> response) {
				
                data_group_jenis_transaksi_api response_data = response.body();
                adapter.updateResults(response_data.get_data_group_jenis_transaksi());

				int jumlah_data = data_group_jenis_transaksi_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_group_jenis_transaksi_activity_v2.this, "Data Berhasil Diperbarui",
            ...
            @Override
            public void onFailure(Call<data_group_jenis_transaksi_api> call, Throwable t) {
				if (isRefresh){
					loading.hideDialog();
                    isRefresh = false;
                }
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_group_jenis_transaksi_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_group_jenis_transaksi_activity_v2.this,
