...
public class data_event_adapter extends BaseAdapter {

    Activity activity;
    ArrayList<data_event_apidata> data;
    TextView id_event
			,tanggal
			,judul
			,foto
    ...
    public data_event_adapter(Activity activity, ArrayList<data_event_apidata> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate( R.layout.data_event_tampil, null);
        }
        ...
        if (p != null) {
            ...
            id_event = (TextView) v.findViewById(R.id.id_event);
            ...
            tombol_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("id_event", data.get(position).get_id_event());
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
									...
									mAPIService.proses_hapus_data_event(
											data.get(position).get_id_event(),
											token
									).enqueue(new Callback<Object>() {			  
										@Override
										public void onResponse(Call<Object> call, Response<Object> response) {
											((data_event_activity)activity).fetch_data_event();
										}
            ...
            id_event.setText("id_event "+data.get(position).get_id_event());
