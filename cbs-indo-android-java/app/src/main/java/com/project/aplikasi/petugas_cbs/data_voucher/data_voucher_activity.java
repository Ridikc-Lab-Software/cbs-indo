...
public class data_voucher_activity extends AppCompatActivity {

    ArrayList<data_voucher_apidata> result = new ArrayList<>();
    data_voucher_adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.data_voucher_activity );

        data_voucher_tampil = (ListView) findViewById(R.id.data_voucher_tampil);
        tombol_tambah = (Button) findViewById(R.id.tombol_tambah);
		tombol_refresh = (Button) findViewById(R.id.tombol_refresh);
		loading = new loading(this);

        adapter = new data_voucher_adapter(this, result);
        data_voucher_tampil.setAdapter(adapter);
        data_voucher_tampil.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_voucher_activity.this, data_voucher_tambah.class);
		...
		tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fetch_data_voucher();
				 Toast.makeText(data_voucher_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_voucher(){
        ...
        mAPIService.tampil_data_voucher("", "", "","","","", "Bearer "+token
