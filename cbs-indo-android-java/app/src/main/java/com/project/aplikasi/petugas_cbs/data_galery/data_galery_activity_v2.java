...
public class data_galery_activity_v2 extends AppCompatActivity {

    ArrayList<data_galery_apidata> result = new ArrayList<>();
    data_galery_adapter_v2 adapter;
    RecyclerView data_galery_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_galery_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_galery_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_galery_activity_v2.this,
                        data_galery_tambah.class);
    ...
    public void fetch_data_galery(){
        ...
        mAPIService.tampil_data_galery(
                "","", "", "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_galery_api> call, Response<data_galery_api> response) {
				...
				int jumlah_data = data_galery_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_galery_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_galery_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_galery_activity_v2.this,
