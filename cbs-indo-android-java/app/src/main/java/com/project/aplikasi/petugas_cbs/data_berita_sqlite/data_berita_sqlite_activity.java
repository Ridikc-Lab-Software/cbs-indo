...
public class data_berita_sqlite_activity extends AppCompatActivity {

    private RecyclerView data_berita_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_berita_activity_v2);
        ...
        data_berita_tampil = (RecyclerView) findViewById(R.id.data_berita_tampil);
        data_berita_tampil.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(data_berita_sqlite_activity.this);
        data_berita_tampil.setLayoutManager(layoutManager);
        fetch_data_berita_sqlite();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Tambah
                Intent intent = new Intent( data_berita_sqlite_activity.this, data_berita_sqlite_tambah.class);
        ...
        tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Refresh
                fetch_data_berita_sqlite();
                Toast.makeText(data_berita_sqlite_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_berita_sqlite(){
        dbHandler = new data_berita_sqlite_dbhandler( data_berita_sqlite_activity.this);
        datalist = dbHandler.get_semua_data_berita_sqlite();
        adapter = new data_berita_sqlite_adapter(data_berita_sqlite_activity.this, datalist );
        data_berita_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
        if (adapter.getItemCount() == 0){

            data_berita_tampil.setVisibility(View.GONE);
        } else {

            data_berita_tampil.setVisibility(View.VISIBLE);
            data_berita_tampil.addOnItemTouchListener(
                    new data_berita_sqlite_recyclerclick(getApplicationContext(), new data_berita_sqlite_recyclerclick.OnItemClickListener() {
                        @Override public void onItemClick(View view, int position) {
                            data_berita_sqlite_data mhs = datalist.get(position);
    ...
    private String[] spinnerArray = {
     ...
     private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_berita_sqlite_activity.this);
        inflater = getLayoutInflater();
        dialogView = inflater.inflate(R.layout.data_berita_pencarian, null);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_berita_sqlite_activity.this,
    ...
    private void fetch_cari()
    {
        ...
        dbHandler = new data_berita_sqlite_dbhandler( data_berita_sqlite_activity.this);
        datalist = dbHandler.get_data_berita_sqlite(berdasarkan,isi,tanggal1,tanggal2,limit,halaman);
        adapter = new data_berita_sqlite_adapter(data_berita_sqlite_activity.this, datalist );
        data_berita_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
