...
public class data_event_sqlite_tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_event.setText( config_global.generate_id( data_event_sqlite_tambah.this,"data_event") );
        ...
        button_tambahdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validasi =="gagal") {
                    Toast.makeText( data_event_sqlite_tambah.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
                    hideLoading();
                }  else {
                    //proses simpan
                    dbHandler.tambah_data_event_sqlite( new data_event_sqlite_data(
                    ...
                    adapter = new data_event_sqlite_adapter( data_event_sqlite_tambah.this, data_event_sqliteList );
                    adapter.notifyDataSetChanged();
                    Toast.makeText( data_event_sqlite_tambah.this, "Berhasil Menambahkan Data", Toast.LENGTH_SHORT ).show();
                    setResult( RESULT_OK );
