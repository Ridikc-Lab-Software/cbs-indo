...
public class data_event_activity_v2 extends AppCompatActivity {

    ArrayList<data_event_apidata> result = new ArrayList<>();
    data_event_adapter_v2 adapter;
    RecyclerView data_event_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_event_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_event_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_event_activity_v2.this,
                        data_event_tambah.class);
    ...
    public void fetch_data_event(){
        ...
        mAPIService.tampil_data_event(
            ...
            public void onResponse(Call<data_event_api> call, Response<data_event_api> response) {
				...
				int jumlah_data = data_event_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_event_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_event_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_event_activity_v2.this,
