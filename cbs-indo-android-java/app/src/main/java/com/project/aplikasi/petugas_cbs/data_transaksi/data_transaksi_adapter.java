...
public class data_transaksi_adapter extends BaseAdapter {
    ...
    public data_transaksi_adapter(Activity activity, ArrayList<data_transaksi_apidata> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate( R.layout.data_transaksi_tampil, null);
        }
        ...
        if (p != null) {
            ...
            tombol_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("id_transaksi", data.get(position).get_id_transaksi());
                                ...
                                public void onClick(DialogInterface dialog, int which) {
									...
									mAPIService.proses_hapus_data_transaksi(
										...
										public void onResponse(Call<Object> call, Response<Object> response) {
											((data_transaksi_activity)activity).fetch_data_transaksi();
										}
            ...
            id_transaksi.setText("id_transaksi "+data.get(position).get_id_transaksi());
