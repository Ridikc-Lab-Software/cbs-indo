...
public class data_berita_activity_v2 extends AppCompatActivity {

    ArrayList<data_berita_apidata> result = new ArrayList<>();
    data_berita_adapter_v2 adapter;
    RecyclerView data_berita_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_berita_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_berita_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_berita_activity_v2.this,
                        data_berita_tambah.class);
    ...
    public void fetch_data_berita(){
        ...
        mAPIService.tampil_data_berita(
                "","", "", "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_berita_api> call, Response<data_berita_api> response) {
				...
				int jumlah_data = data_berita_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_berita_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_berita_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_berita_activity_v2.this,
