...
public class data_transaksi_activity_v2 extends AppCompatActivity {




    ArrayList<data_transaksi_apidata> result = new ArrayList<>();
    data_transaksi_adapter_v2 adapter;
    RecyclerView data_transaksi_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_transaksi_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_transaksi_activity_v2.this);
        ...
        isRefresh = true;
        fetch_data_transaksi();

        tombol_tambah.setVisibility(View.GONE);
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( data_transaksi_activity_v2.this,
                        data_transaksi_tambah.class);
    ...
    public void fetch_data_transaksi(){
		
		if (isRefresh){
			loading.showDialog(1,"Please Wait","Loading Data..");
          }
        String token = new config_global().ambil(this);
        mAPIService.tampil_data_transaksi(
                "","", "", "","","", "Bearer "+token
        ).enqueue(new Callback<data_transaksi_api>() {
            @Override
            public void onResponse(Call<data_transaksi_api> call, Response<data_transaksi_api> response) {
				
                data_transaksi_api response_data = response.body();
                adapter.updateResults(response_data.get_data_transaksi());

				int jumlah_data = data_transaksi_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_transaksi_activity_v2.this, "Data Berhasil Diperbarui",
            ...
            @Override
            public void onFailure(Call<data_transaksi_api> call, Throwable t) {
				if (isRefresh){
					loading.hideDialog();
                    isRefresh = false;
                }
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_transaksi_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_transaksi_activity_v2.this,
