...
public class data_petugas_adapter extends BaseAdapter {

    Activity activity;
    ArrayList<data_petugas_apidata> data;
    TextView id_petugas
			,nama
			,alamat
			,no_telepon
    ...
    public data_petugas_adapter(Activity activity, ArrayList<data_petugas_apidata> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate( R.layout.data_petugas_tampil, null);
        }
        ...
        if (p != null) {
            ...
            tombol_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("id_petugas", data.get(position).get_id_petugas());
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
									...
									mAPIService.proses_hapus_data_petugas(
											data.get(position).get_id_petugas(),
											token
									).enqueue(new Callback<Object>() {			  
										@Override
										public void onResponse(Call<Object> call, Response<Object> response) {
											((data_petugas_activity)activity).fetch_data_petugas();
										}
            ...
            id_petugas.setText("id_petugas "+data.get(position).get_id_petugas());
