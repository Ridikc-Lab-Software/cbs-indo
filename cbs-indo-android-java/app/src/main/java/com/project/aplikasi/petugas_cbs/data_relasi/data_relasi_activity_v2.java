...
public class data_relasi_activity_v2 extends AppCompatActivity {

    ArrayList<data_relasi_apidata> result = new ArrayList<>();
    data_relasi_adapter_v2 adapter;
    RecyclerView data_relasi_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_relasi_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_relasi_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_relasi_activity_v2.this,
                        data_relasi_tambah.class);
    ...
    public void fetch_data_relasi(){
        ...
        mAPIService.tampil_data_relasi(
                "","", "", "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_relasi_api> call, Response<data_relasi_api> response) {
				...
				int jumlah_data = data_relasi_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_relasi_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_relasi_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_relasi_activity_v2.this,
