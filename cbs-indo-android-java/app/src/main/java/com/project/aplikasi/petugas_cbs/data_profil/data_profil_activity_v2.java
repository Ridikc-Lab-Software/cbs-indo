...
public class data_profil_activity_v2 extends AppCompatActivity {

    ArrayList<data_profil_apidata> result = new ArrayList<>();
    data_profil_adapter_v2 adapter;
    RecyclerView data_profil_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_profil_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_profil_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_profil_activity_v2.this,
                        data_profil_tambah.class);
    ...
    public void fetch_data_profil(){
		
		if (isRefresh){
			loading.showDialog(1,"Please Wait","Loading Data..");
          }
        String token = new config_global().ambil(this);
        mAPIService.tampil_data_profil(
                "","", "", "","","", "Bearer "+token
        ).enqueue(new Callback<data_profil_api>() {
            @Override
            public void onResponse(Call<data_profil_api> call, Response<data_profil_api> response) {
				
                data_profil_api response_data = response.body();
                adapter.updateResults(response_data.get_data_profil());

				int jumlah_data = data_profil_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_profil_activity_v2.this, "Data Berhasil Diperbarui",
            ...
            @Override
            public void onFailure(Call<data_profil_api> call, Throwable t) {
				if (isRefresh){
					loading.hideDialog();
                    isRefresh = false;
                }
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_profil_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_profil_activity_v2.this,
