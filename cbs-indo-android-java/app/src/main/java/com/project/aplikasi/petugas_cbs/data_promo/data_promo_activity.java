...
public class data_promo_activity extends AppCompatActivity {

    ArrayList<data_promo_apidata> result = new ArrayList<>();
    data_promo_adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.data_promo_activity );

        data_promo_tampil = (ListView) findViewById(R.id.data_promo_tampil);
        tombol_tambah = (Button) findViewById(R.id.tombol_tambah);
		tombol_refresh = (Button) findViewById(R.id.tombol_refresh);
		loading = new loading(this);

        adapter = new data_promo_adapter(this, result);
        data_promo_tampil.setAdapter(adapter);
        data_promo_tampil.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_promo_activity.this, data_promo_tambah.class);
		...
		tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fetch_data_promo();
				 Toast.makeText(data_promo_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_promo(){
        ...
        mAPIService.tampil_data_promo("", "", "","","","", "Bearer "+token
