...
public class data_group_jenis_transaksi_sqlite_data {
    ...
    public data_group_jenis_transaksi_sqlite_data() {
    }

    public data_group_jenis_transaksi_sqlite_data(String id_group_jenis_transaksi
	,String nama_group
