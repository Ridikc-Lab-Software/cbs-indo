...
public class data_promo_sqlite_activity extends AppCompatActivity {

    private RecyclerView data_promo_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data_promo_tampil.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(data_promo_sqlite_activity.this);
        data_promo_tampil.setLayoutManager(layoutManager);
        fetch_data_promo_sqlite();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Tambah
                Intent intent = new Intent( data_promo_sqlite_activity.this, data_promo_sqlite_tambah.class);
        ...
        tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Refresh
                fetch_data_promo_sqlite();
                Toast.makeText(data_promo_sqlite_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_promo_sqlite(){
        dbHandler = new data_promo_sqlite_dbhandler( data_promo_sqlite_activity.this);
        datalist = dbHandler.get_semua_data_promo_sqlite();
        adapter = new data_promo_sqlite_adapter(data_promo_sqlite_activity.this, datalist );
        ...
        if (adapter.getItemCount() == 0){
            ...
            data_promo_tampil.addOnItemTouchListener(
                    new data_promo_sqlite_recyclerclick(getApplicationContext(), new data_promo_sqlite_recyclerclick.OnItemClickListener() {
                        @Override public void onItemClick(View view, int position) {
                            data_promo_sqlite_data mhs = datalist.get(position);
    ...
    private String[] spinnerArray = {
     ...
     private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_promo_sqlite_activity.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_promo_sqlite_activity.this,
    ...
    private void fetch_cari()
    {
        ...
        dbHandler = new data_promo_sqlite_dbhandler( data_promo_sqlite_activity.this);
        datalist = dbHandler.get_data_promo_sqlite(berdasarkan,isi,tanggal1,tanggal2,limit,halaman);
        adapter = new data_promo_sqlite_adapter(data_promo_sqlite_activity.this, datalist );
        data_promo_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
