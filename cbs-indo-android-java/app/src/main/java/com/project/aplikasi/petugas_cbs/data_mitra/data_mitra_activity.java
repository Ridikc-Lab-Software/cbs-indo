...
public class data_mitra_activity extends AppCompatActivity {

    ArrayList<data_mitra_apidata> result = new ArrayList<>();
    data_mitra_adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.data_mitra_activity );

        data_mitra_tampil = (ListView) findViewById(R.id.data_mitra_tampil);
        tombol_tambah = (Button) findViewById(R.id.tombol_tambah);
		tombol_refresh = (Button) findViewById(R.id.tombol_refresh);
		loading = new loading(this);

        adapter = new data_mitra_adapter(this, result);
        data_mitra_tampil.setAdapter(adapter);
        data_mitra_tampil.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_mitra_activity.this, data_mitra_tambah.class);
		...
		tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fetch_data_mitra();
				 Toast.makeText(data_mitra_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_mitra(){
        ...
        mAPIService.tampil_data_mitra("", "", "","","","", "Bearer "+token
