...
public class data_pengaturan_point_sqlite_tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_pengaturan_point.setText( config_global.generate_id( data_pengaturan_point_sqlite_tambah.this,"data_pengaturan_point") );
        ...
        button_tambahdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validasi =="gagal") {
                    Toast.makeText( data_pengaturan_point_sqlite_tambah.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
                    hideLoading();
                }  else {
                    //proses simpan
                    dbHandler.tambah_data_pengaturan_point_sqlite( new data_pengaturan_point_sqlite_data(
                    ...
                    adapter = new data_pengaturan_point_sqlite_adapter( data_pengaturan_point_sqlite_tambah.this, data_pengaturan_point_sqliteList );
                    adapter.notifyDataSetChanged();
                    Toast.makeText( data_pengaturan_point_sqlite_tambah.this, "Berhasil Menambahkan Data", Toast.LENGTH_SHORT ).show();
                    setResult( RESULT_OK );
