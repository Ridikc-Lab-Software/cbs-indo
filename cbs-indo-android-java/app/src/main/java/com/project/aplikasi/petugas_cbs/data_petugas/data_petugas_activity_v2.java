...
public class data_petugas_activity_v2 extends AppCompatActivity {

    ArrayList<data_petugas_apidata> result = new ArrayList<>();
    data_petugas_adapter_v2 adapter;
    RecyclerView data_petugas_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_petugas_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_petugas_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_petugas_activity_v2.this,
                        data_petugas_tambah.class);
    ...
    public void fetch_data_petugas(){
        ...
        mAPIService.tampil_data_petugas(
                "","", "", "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_petugas_api> call, Response<data_petugas_api> response) {
				...
				int jumlah_data = data_petugas_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_petugas_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_petugas_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_petugas_activity_v2.this,
