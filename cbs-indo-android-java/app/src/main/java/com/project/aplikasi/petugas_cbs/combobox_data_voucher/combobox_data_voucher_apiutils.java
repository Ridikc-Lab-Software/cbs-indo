...
public class combobox_data_voucher_apiutils {
    public static combobox_data_voucher_apiservice getAPIService() {
        return config_apiclient.getClient(BASE_URL).create(combobox_data_voucher_apiservice.class);
    }
}
