...
public class data_galery_sqlite_activity extends AppCompatActivity {

    private RecyclerView data_galery_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_galery_activity_v2);
        ...
        data_galery_tampil = (RecyclerView) findViewById(R.id.data_galery_tampil);
        data_galery_tampil.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(data_galery_sqlite_activity.this);
        data_galery_tampil.setLayoutManager(layoutManager);
        fetch_data_galery_sqlite();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Tambah
                Intent intent = new Intent( data_galery_sqlite_activity.this, data_galery_sqlite_tambah.class);
        ...
        tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Refresh
                fetch_data_galery_sqlite();
                Toast.makeText(data_galery_sqlite_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_galery_sqlite(){
        dbHandler = new data_galery_sqlite_dbhandler( data_galery_sqlite_activity.this);
        datalist = dbHandler.get_semua_data_galery_sqlite();
        adapter = new data_galery_sqlite_adapter(data_galery_sqlite_activity.this, datalist );
        data_galery_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
        if (adapter.getItemCount() == 0){

            data_galery_tampil.setVisibility(View.GONE);
        } else {

            data_galery_tampil.setVisibility(View.VISIBLE);
            data_galery_tampil.addOnItemTouchListener(
                    new data_galery_sqlite_recyclerclick(getApplicationContext(), new data_galery_sqlite_recyclerclick.OnItemClickListener() {
                        @Override public void onItemClick(View view, int position) {
                            data_galery_sqlite_data mhs = datalist.get(position);
    ...
    private String[] spinnerArray = {
     ...
     private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_galery_sqlite_activity.this);
        inflater = getLayoutInflater();
        dialogView = inflater.inflate(R.layout.data_galery_pencarian, null);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_galery_sqlite_activity.this,
    ...
    private void fetch_cari()
    {
        ...
        dbHandler = new data_galery_sqlite_dbhandler( data_galery_sqlite_activity.this);
        datalist = dbHandler.get_data_galery_sqlite(berdasarkan,isi,tanggal1,tanggal2,limit,halaman);
        adapter = new data_galery_sqlite_adapter(data_galery_sqlite_activity.this, datalist );
        data_galery_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
