...
public class data_jenis_transaksi_activity_v2 extends AppCompatActivity {

    public static String id_member,id_kategori_member,nama,point;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_jenis_transaksi_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_jenis_transaksi_activity_v2.this);
        ...
        id_kategori_member = (bundle.getString("id_kategori_member"));
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_jenis_transaksi_activity_v2.this,
                        data_jenis_transaksi_tambah.class);
    ...
    public void fetch_data_jenis_transaksi(){
        ...
        mAPIService.tampil_data_jenis_transaksi(
                "",id_kategori_member, "", "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_jenis_transaksi_api> call, Response<data_jenis_transaksi_api> response) {
				...
				int jumlah_data = data_jenis_transaksi_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_jenis_transaksi_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_jenis_transaksi_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_jenis_transaksi_activity_v2.this,
