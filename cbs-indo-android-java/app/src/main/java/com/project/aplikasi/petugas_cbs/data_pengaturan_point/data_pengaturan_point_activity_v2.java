...
public class data_pengaturan_point_activity_v2 extends AppCompatActivity {

    ArrayList<data_pengaturan_point_apidata> result = new ArrayList<>();
    data_pengaturan_point_adapter_v2 adapter;
    RecyclerView data_pengaturan_point_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_pengaturan_point_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_pengaturan_point_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_pengaturan_point_activity_v2.this,
                        data_pengaturan_point_tambah.class);
    ...
    public void fetch_data_pengaturan_point(){
        ...
        mAPIService.tampil_data_pengaturan_point(
                "","", "", "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_pengaturan_point_api> call, Response<data_pengaturan_point_api> response) {
				...
				int jumlah_data = data_pengaturan_point_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_pengaturan_point_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_pengaturan_point_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_pengaturan_point_activity_v2.this,
