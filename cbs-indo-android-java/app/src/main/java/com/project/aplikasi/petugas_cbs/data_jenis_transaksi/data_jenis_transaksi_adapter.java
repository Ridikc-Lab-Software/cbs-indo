...
public class data_jenis_transaksi_adapter extends BaseAdapter {
    ...
    public data_jenis_transaksi_adapter(Activity activity, ArrayList<data_jenis_transaksi_apidata> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate( R.layout.data_jenis_transaksi_tampil, null);
        }
        ...
        if (p != null) {
            ...
            tombol_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
					...
					bundle.putString("jenis_transaksi", data.get(position).get_jenis_transaksi());
                    bundle.putString("gambar_logo", data.get(position).get_gambar_logo());
                    
                    
                    Intent intent = new Intent(activity, data_jenis_transaksi_edit.class);
                                ...
                                public void onClick(DialogInterface dialog, int which) {
									...
									mAPIService.proses_hapus_data_jenis_transaksi(
										...
										public void onResponse(Call<Object> call, Response<Object> response) {
											((data_jenis_transaksi_activity)activity).fetch_data_jenis_transaksi();
										}
			...
			jenis_transaksi.setText("jenis_transaksi "+data.get(position).get_jenis_transaksi());
