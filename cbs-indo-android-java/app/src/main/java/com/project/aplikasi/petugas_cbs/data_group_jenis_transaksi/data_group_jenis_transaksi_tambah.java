...
public class data_group_jenis_transaksi_tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombol_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                id_group_jenis_transaksi.setText( config_global.generate_id(data_group_jenis_transaksi_tambah.this,"data_group_jenis_transaksi") );
                validasi ="berhasil";
                validasiForm((ViewGroup) findViewById(R.id.group));
                if (validasi =="gagal") {
                    loading.hideDialog();
					Toast.makeText( data_group_jenis_transaksi_tambah.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
                    
                }  else {
					
				String token = "Bearer " + new config_global().ambil(data_group_jenis_transaksi_tambah.this);
                mAPIService.proses_simpan_data_group_jenis_transaksi(id_group_jenis_transaksi.getText().toString()
                    ...
                    public void onResponse(Call<Object> call, Response<Object> response) {
                        Toast.makeText( data_group_jenis_transaksi_tambah.this, "Berhasil Disimpan", Toast.LENGTH_LONG).show();
                        setResult(RESULT_OK);
                    ...
                    public void onFailure(Call<Object> call, Throwable t) {
                        Toast.makeText( data_group_jenis_transaksi_tambah.this, "Gagal Disimpan", Toast.LENGTH_LONG).show();
						 loading.hideDialog();
                    }
                });
				}
