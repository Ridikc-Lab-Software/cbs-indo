...
public class data_voucher_tambah_v2 extends AppCompatActivity {
...
;
    ...
    data_voucher_tambah_v2_adapter adapter;
    ListView data_voucher_tampil;
	loading loading;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.data_voucher_tambah_v2 );
        ...
        data_voucher_tampil = (ListView) findViewById(R.id.cvdata_voucher);

        adapter = new data_voucher_tambah_v2_adapter(this, result);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
				...
				id_voucher.setText( config_global.generate_id(data_voucher_tambah_v2.this,"data_voucher") );
				validasi ="berhasil";
                validasiForm((ViewGroup) findViewById(R.id.group));
                if (validasi =="gagal") {
                    loading.hideDialog();
					Toast.makeText( data_voucher_tambah_v2.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
					
                }  else {
					String token = "Bearer " + new config_global().ambil(data_voucher_tambah_v2.this);
					mAPIService.proses_simpan_data_voucher(id_voucher.getText().toString()
						...
						public void onResponse(Call<Object> call, Response<Object> response) {
							Toast.makeText( data_voucher_tambah_v2.this, "Berhasil Disimpan",
									Toast.LENGTH_LONG).show();
							result.add(new data_voucher_apidata(
						...
						public void onFailure(Call<Object> call, Throwable t) {
							Toast.makeText( data_voucher_tambah_v2.this, "Gagal Disimpan",
									Toast.LENGTH_LONG).show();
									loading.hideDialog();
						}
					});
