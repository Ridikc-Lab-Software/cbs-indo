...
public class data_group_jenis_transaksi_sqlite_tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_group_jenis_transaksi_tambah );
        ...
        id_group_jenis_transaksi.setText( config_global.generate_id( data_group_jenis_transaksi_sqlite_tambah.this,"data_group_jenis_transaksi") );
        ...
        button_tambahdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validasi =="gagal") {
                    Toast.makeText( data_group_jenis_transaksi_sqlite_tambah.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
                    hideLoading();
                }  else {
                    //proses simpan
                    dbHandler.tambah_data_group_jenis_transaksi_sqlite( new data_group_jenis_transaksi_sqlite_data(
                    ...
                    adapter = new data_group_jenis_transaksi_sqlite_adapter( data_group_jenis_transaksi_sqlite_tambah.this, data_group_jenis_transaksi_sqliteList );
                    adapter.notifyDataSetChanged();
                    Toast.makeText( data_group_jenis_transaksi_sqlite_tambah.this, "Berhasil Menambahkan Data", Toast.LENGTH_SHORT ).show();
                    setResult( RESULT_OK );
